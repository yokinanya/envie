...
## 自托管
> [!TIP]  
> 如果你不想自己部署，Envie Cloud 也提供托管服务：个人使用永久免费，团队也有相对实惠的按用户计费方案。
>
...
镜像使用方式见 Docker Hub 说明，部署细节可参考 [docs/self-hosting/host-with-docker.md](./docs/self-hosting/host-with-docker.md)。
